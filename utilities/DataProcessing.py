...
def generate_iterator(path, augmentation = True, color_mode = 'rgb', batch_size = 32, shuffle = True, target_size = (256, 256),
    ...
    if augmentation:
        ...
        Generator = tf.keras.preprocessing.image.ImageDataGenerator(rescale = rescale)
    print('Generating the iterator without performing augmenation...');
    Iterator = Generator.flow_from_directory(directory = path, color_mode = color_mode,
                                             batch_size = batch_size, shuffle = shuffle, 
                                             target_size=target_size, seed = seed, interpolation=interpolation,
